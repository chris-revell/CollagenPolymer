...
Ebend_in       = 1000.0     # Internal bending modulus of trimer
...
#using BenchmarkTools
#println("Timing")
#@btime simulate(nTrimers,L,σ,ϵLJ_in,k_in,Ebend_in,boxSize,tMax,0,0)
#@benchmark simulate(nTrimers,L,σ,ϵLJ_in,k_in,Ebend_in,boxSize,tMax,0,0)
